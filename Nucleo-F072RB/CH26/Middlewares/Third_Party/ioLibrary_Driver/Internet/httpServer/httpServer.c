...
#ifdef _HTTPSERVER_DEBUG_
			printf("> HTTPSocket[%d] : ESTABLISHED\r\n", s);
#endif
...
#endif
#ifdef _HTTPSERVER_DEBUG_
						printf("> HTTPSocket[%d] : [State] STATE_HTTP_IDLE\r\n", s);
#endif
...
//#endif
		...
		case SOCK_LISTEN:
		  printf("> HTTPSocket[%d] : SOCK_LISTEN\r\n", s);
			break;
...
#ifdef _HTTPSERVER_DEBUG_
      printf("HTTPSocket[%d] : http_process_handler()\r\n", s);
#endif
...
#ifdef _HTTPSERVER_DEBUG_
      printf("HTTPSocket[%d] : http_process_handler():: METHOD_ERR\r\n", s);
#endif
			break;
		...
		case METHOD_GET :
#ifdef _HTTPSERVER_DEBUG_
      printf("HTTPSocket[%d] : http_process_handler():: METHOD_GET\r\n", s);
#endif
		...
		default :
#ifdef _HTTPSERVER_DEBUG_
      printf("HTTPSocket[%d] : http_process_handler():: STATUS_BAD_REQ\r\n", s);
#endif
			http_status = STATUS_BAD_REQ;
			send_http_response_header(s, 0, 0, http_status);
			break;
